package com.example.jdbc.jdbcautocommit;
...
//    private static final String UPDATE_PERSON_AGE_BY_NAME_SQL
//      = "UPDATE Person p JOIN (SELECT id FROM Person WHERE name = ?) AS temp ON p.id = temp.id SET p.age = ?";
    ...
    public static final String DROP_TABLE_IF_EXISTS = "DROP TABLE IF EXISTS Person";
    private static Connection connection1;
    private static Connection connection2;
    
    @BeforeAll
    static void setup() throws SQLException {
//        connection1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/my_db", "root", "password");
        connection1 = DriverManager.getConnection("jdbc:h2:mem:test", "sa", "");
        dropPersonTable(connection1);
        createPersonTable(connection1);
        
//        connection2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/my_db", "root", "password");
        connection2 = DriverManager.getConnection("jdbc:h2:mem:test", "sa", "");
    }
    ...
    private static void dropPersonTable(Connection connection) throws SQLException {
        try(Statement statement = connection.createStatement()) {
