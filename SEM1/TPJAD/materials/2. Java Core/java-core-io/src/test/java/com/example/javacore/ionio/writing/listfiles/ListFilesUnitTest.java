package com.example.javacore.ionio.writing.listfiles;

import com.example.javacore.ionio.writing.ListFiles;
...
public class ListFilesUnitTest {
    ...
    private static final Set<String> EXPECTED_FILE_SET = new HashSet<>() {
        {
            add("test.xml");
            add("employee.json");
            add("students.json");
