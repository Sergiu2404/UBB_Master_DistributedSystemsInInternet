package com.example.javacore.nio.filevisitor;
...
public class FileSearchExample implements FileVisitor<Path> {
    ...
    public static void main(String[] args) throws IOException {
        Path startingDir = Paths.get("/Users/ioan.badarinza/Documents/workspace/TPJAD/");
        FileSearchExample crawler = new FileSearchExample("file.txt", startingDir);
