...
public class Client3GF {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (abac == null) try {
            abac = (AbacR) context.lookup("java:global/3ejbCs/AbacBean!p.interfaces.AbacR");
        } catch (Exception e) { }
        if (abac == null) try {
            abac = (AbacR) context.lookup("java:global/4ear123/3ejbCs/AbacBean!p.interfaces.AbacR");
                System.out.println("abac");
        } catch (Exception e) { }
        if (counter == null) try {
            counter = (CounterR) context.lookup("java:global/3ejbCs/CounterBean!p.interfaces.CounterR");
        } catch (Exception e) { }
        if (counter == null) try {
            counter = (CounterR) context.lookup("java:global/4ear123/3ejbCs/CounterBean!p.interfaces.CounterR");
        } catch (Exception e) { }
