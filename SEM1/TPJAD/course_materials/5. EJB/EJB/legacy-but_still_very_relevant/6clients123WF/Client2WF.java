...
public class Client2WF {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (abac == null) try {
            abac = (Abac2) context.lookup("2ejbSingleton/Abac2Bean!p.interfaces.Abac2");
        } catch (Exception e) { }
        if (abac == null) try {
            abac = (Abac2) context.lookup("4ear123/2ejbSingleton/Abac2Bean!p.interfaces.Abac2");
        } catch (Exception e) { }
        if (counter == null) try {
            counter = (Counter2) context.lookup("2ejbSingleton/Counter2Bean!p.interfaces.Counter2");
        } catch (Exception e) { }
        if (counter == null) try {
            counter = (Counter2) context.lookup("4ear123/2ejbSingleton/Counter2Bean!p.interfaces.Counter2");
        } catch (Exception e) { }
