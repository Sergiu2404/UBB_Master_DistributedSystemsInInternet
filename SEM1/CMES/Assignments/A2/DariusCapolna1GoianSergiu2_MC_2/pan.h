...
#define PanSource	"smart_lighting.pml"
...
S_F_MAP src_file2 [] = {
	{ ""-"", 0, 0 },
	{ "D:\UBB_Master_DistributedSystemsInInternet\SEM1\CMES\Assignments\A2\DariusCapolna1GoianSergiu2_MC_2\smart_lighting.ltl", 1, 11 },
	{ ""-"", 12, 13 }
};
uchar reached2 [] = {
	  0,   1,   1,   1,   1,   0,   1,   1, 
...
#define nstates1	21	/* Controller */
#define endstate1	20
short src_ln1 [] = {
	  0,  49,  51,  52,  53,  54,  56,  57, 
	 58,  50,  60,  48,  63,  64,  65,  66, 
	 62,  47,  69,  47,  69,   0, };
S_F_MAP src_file1 [] = {
	{ ""-"", 0, 0 },
	{ "smart_lighting.pml", 1, 20 },
	{ ""-"", 21, 22 }
};
uchar reached1 [] = {
	  0,   1,   1,   0,   0,   0,   1,   0, 
...
#define nstates0	26	/* Sensor */
#define endstate0	25
short src_ln0 [] = {
	  0,  18,  19,  20,  21,  22,  23,  17, 
	 27,  28,  29,  30,  26,  34,  35,  37, 
	 37,  38,  38,  36,  40,  33,  16,  42, 
	 16,  42,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "smart_lighting.pml", 1, 25 },
	{ ""-"", 26, 27 }
};
uchar reached0 [] = {
	  0,   1,   0,   0,   0,   0,   0,   1, 
...
#define Air1	(sizeof(P1) - Offsetof(P1, _5_signal) - 1*sizeof(uchar))
#define PSensor	((P0 *)this)
typedef struct P0 { /* Sensor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
} P0;
...
typedef struct State {
	...
	#endif
#endif
	unsigned lightIsOn : 1;
	unsigned personPresent : 1;
	uchar sensor_to_controller;
	uchar controller_to_sensor;
	uchar sv[VECTORSZ];
} State;

#define HAS_TRACK	0
/* hidden variable: */	uchar waitingAck;
